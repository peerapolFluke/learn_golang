...
func (uc *UserCreate) SetProfileImgURL(s string) *UserCreate {
	uc.mutation.SetProfileImgURL(s)
	return uc
}

// SetNillableProfileImgURL sets the "profile_img_url" field if the given value is not nil.
func (uc *UserCreate) SetNillableProfileImgURL(s *string) *UserCreate {
	if s != nil {
		uc.SetProfileImgURL(*s)
	}
	return uc
}

// SetRubberStampURL sets the "rubber_stamp_url" field.
func (uc *UserCreate) SetRubberStampURL(s string) *UserCreate {
	uc.mutation.SetRubberStampURL(s)
	return uc
}

// SetNillableRubberStampURL sets the "rubber_stamp_url" field if the given value is not nil.
func (uc *UserCreate) SetNillableRubberStampURL(s *string) *UserCreate {
	if s != nil {
		uc.SetRubberStampURL(*s)
	}
	return uc
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.ProfileImgURL(); ok {
		_spec.SetField(user.FieldProfileImgURL, field.TypeString, value)
		_node.ProfileImgURL = value
	}
	if value, ok := uc.mutation.RubberStampURL(); ok {
		_spec.SetField(user.FieldRubberStampURL, field.TypeString, value)
		_node.RubberStampURL = value
	}
